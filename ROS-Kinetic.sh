...
sudo apt-get install python-pip python-scipy python-opencv python-matplotlib python-serial python-empy python-wxgtk3.0 python-lxml python-pexpect python-catkin-tools python-wstool python-rosinstall python3-pip python3-pyside ccache gawk git libprotobuf-dev libprotoc-dev protobuf-compiler libeigen3-dev libgazebo7-dev libgstreamer1.0-dev qtcreator pyqt5-dev-tools ros-kinetic-mavros ros-kinetic-octomap ros-kinetic-octomap-ros ros-kinetic-octomap-msgs ros-kinetic-octomap-rviz-plugins ros-kinetic-gazebo-* ros-kinetic-image-transport* libignition-math2-dev -y
